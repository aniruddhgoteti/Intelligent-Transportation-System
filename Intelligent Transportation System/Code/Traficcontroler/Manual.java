...
class JunctionDisplayManual extends JPanel implements ActionListener
{
	...
	{
		Buttons[currentLane].setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Yellow.JPG"));
		Buttons[currentLane].setForeground(Color.YELLOW);
		Buttons[nextLane].setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Yellow.JPG"));
	...
	void changeTime()
	{
		if(Latency>0)
		{
			...
			if(Latency==0)
			{
				jButton3.setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Red.JPG"));
				jButton3.setForeground(Color.RED); 
				jButton4.setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Red.JPG"));
				jButton4.setForeground(Color.RED); 
				jButton5.setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Red.JPG"));
				jButton5.setForeground(Color.RED); 
				jButton6.setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Red.JPG"));
				jButton6.setForeground(Color.RED); 
				Buttons[currentLane].setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Green.JPG"));
	...
	public JunctionDisplayManual()
	{
		...
		jButton3.setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\Green.JPG"));       
...
class Manual extends JFrame
{
	...
	private void initComponents() {
		...
		R=new RunManual(JD);        
		R.start();
		jLabel1.setIcon(new javax.swing.ImageIcon("E:\\MyProjects\\RoadMap2.JPG"));
