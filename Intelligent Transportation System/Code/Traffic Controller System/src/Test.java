...
class JunctionDisplay extends JPanel
{
	...
	public JunctionDisplay()
	{
		...
		jLabel3.setIcon(new javax.swing.ImageIcon("Green.JPG"));       
		...
		jLabel4.setIcon(new javax.swing.ImageIcon("Red.JPG"));
		...
		jLabel6.setIcon(new javax.swing.ImageIcon("Red.JPG"));
		...
		jLabel5.setIcon(new javax.swing.ImageIcon("Red.JPG"));
	...
	{
		Labels[currentLane].setIcon(new javax.swing.ImageIcon("Yellow.JPG"));
		Labels[currentLane].setForeground(Color.YELLOW);
		Labels[nextLane].setIcon(new javax.swing.ImageIcon("Yellow.JPG"));
		Labels[nextLane].setForeground(Color.YELLOW);
	}
	void setFgColor(int lane)
	{
		jLabel3.setIcon(new javax.swing.ImageIcon("Red.JPG"));
		...
		Labels[lane].setIcon(new javax.swing.ImageIcon("Green.JPG"));
